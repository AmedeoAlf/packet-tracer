  ...
  configPanel: {
    ...
    "Menu 4"(ctx) {
      return (<p>
        ...
        exampleProp1: <input type="number" value={ctx.state.exampleProp1} onChange={ev => {
          ctx.state.exampleProp1 = +ev.target.value;
          ctx.updateState()
        }} /> <br />
        exampleProp2: <input type="text" value={ctx.state.exampleProp2} onChange={ev => {
